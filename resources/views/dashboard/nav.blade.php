   <nav id="mainNav" class="navbar static-top navbar-toggleable-md navbar-inverse bg-inverse">
   	...
   	<div class="collapse navbar-collapse" id="navbarExample">
   		<ul class="sidebar-nav navbar-nav">
   			...
   			<li class="nav-item ">
   				<a class="nav-link" href="/dashboard/users"><i class="fa fa-fw fa-dashboard"></i> User Management</a>
   			</li>
   			<li class="nav-item ">
   				<a class="nav-link" href="/dashboard/adverification"><i class="fa fa-fw fa-dashboard"></i> Verification</a>
   			</li>
   			@else
   			<li class="nav-item" >
   				<a class="nav-link" href="/dashboard/profile"><i class="fa fa-fw fa-user"></i> Profile</a>
   			</li>
   			<li class="nav-item activePage">
   				<a class="nav-link" href="#"><i class="fa fa-fw fa-buysellads"></i> Iklan</a>
   			</li>
   			<li class="nav-item">
